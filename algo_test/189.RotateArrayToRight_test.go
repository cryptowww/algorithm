...
func TestRotateArrayToRightImplementByTempArray(t *testing.T) {
	result := algo.RotateArrayToRightImplementByTempArray([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 3)
	if result[0] != 7 {
		t.Error("RotateArrayToRightImplementByTempArray failed, expected 7, got ", result[0])
	}
	result2 := algo.RotateArrayToRightImplementByTempArray([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 13)
	if result2[0] != 6 {
...
func TestRotateArrayToRightImplementByReverse(t *testing.T) {
	result := algo.RotateArrayToRightImplementByReverse([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 3)
	if result[0] != 7 {
