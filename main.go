...
func main() {
	...
	fmt.Println(algo.RotateArrayToRightImplementByReverse([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 3))
	fmt.Println(algo.RotateArrayToLeftImplementByTempArray([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 3))
	fmt.Println(algo.RotateArrayToLeftImplementByReverse([]int{1, 2, 3, 4, 5, 6, 7, 8, 9}, 3))
}
